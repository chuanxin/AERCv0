...
(function ($) {
    ...
    function onError(error, inputElement) {  // 'this' is the form element
        ...
        if (replace) {
            ...
            //by HaoHsuan
            //alert(document.URL);
            container.append("<img id='valimg' src='/AWRMTest/Content/images/uncheck.png' width='24' height='24'>");
    ...
    function onSuccess(error) {  // 'this' is the form element
        ...
        if (container) {
            ...
            if (replace) {
                ...
                //by HaoHsuan
                //alert(document.URL);
                container.append("<img id='valimg' src='/AWRMTest/Content/images/check.png' width='24' height='24'>");
            }
        }
    }
