    ...
    $("#UserTable").jqGrid({
       ...
       { name: 'View', index: 'View', width: 45, align: 'center', formatter: viewButton }
        ...
        loadComplete: function (ids) {
            ...
            //$('#pager_center').css('width', '200'); //設定頁數區塊的寬度
            //$('#pager_left').css('width', '600'); //設定功能按鈕的區塊寬度
        }
